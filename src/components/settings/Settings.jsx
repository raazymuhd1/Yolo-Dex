...
const Settings = ({showSettings, setShowSettings}) => {
  return (
    <section className={`h-[50%] w-full ${showSettings ? "translate-y-[0px] opacity-1" : "translate-y-[100px] opacity-0"} absolute bottom-0 left-0 right-0 p-[15px] rounded-[15px] main-theme transition_500`}>
       ...
       <aside className="flex flex-col gap-[20px] mt-[10px]">
          ...
          <aside className="flex items-center gap-[10px]">
            <input type="text" placeholder="deadline" className="w-[150px] placeholder:text-secondary bg-main p-[8px] rounded-[10px] text-[#fff] border-none outline-none" />
