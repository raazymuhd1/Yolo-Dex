...
const Swap = () => {
  ...
  return (
    <section className='w-full h-full flex justify-center'>
       ...
       <div className="flex relative xl:w-[30%] md:w-[70%] w-[80%] mt-[110px] min-h-[500px] max-h-[650px] flex-col rounded-[15px] p-[20px] second-theme"> 
          <div className="flex items-center justify-between w-full"> 
           ...
           <div className="flex w-full h-full flex-col mt-[10px] gap-[20px]">
               ...
               <div className="w-[80%] mx-auto flex items-center gap-[20px]"> 
                  <CustomButton 
                     title={"Approve USDT"} 
                     styles="swap_btns cursor-pointer text-[#fff]"   />
                  <CustomButton 
